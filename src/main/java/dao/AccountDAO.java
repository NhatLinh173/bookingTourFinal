...
public class AccountDAO {
    ...
    public void updateAccount(int id, String username, String email, String phone) {
        String query = "update account set username = ? ,  email =?,phone=? where u_id = ?";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(query);
            ps.setString(1, username);
    ...
    public void updatePass(int id,String password){
        String query = "update account set password = ?  where u_id = ?";
        try{
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(query);
